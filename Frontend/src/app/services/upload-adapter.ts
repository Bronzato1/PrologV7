...
import { FileLoader, UploadResponse } from '@ckeditor/ckeditor5-upload/src/filerepository';
...
export default class UploadAdapter {
  ...
  _initRequest() {
    ...
    // could be different.
    xhr.open('POST', `${baseUrl}posts/upload-image`, true); // Use id in URL
...
// Upload ADAPTOR
export function UploadAdapterPlugin(editor: any) { // Accept id parameter
